   ...
   @section('content')
    <div class="container mx-auto pb-8" id="app" >
        ...
        <header class="grid my-4 mx-2 text-center">
            <h1 class="text-2xl text-gray-900 italic py-2">Editar Profesor</h1>
        </header>

        <div class="mt-5 md:mt-0 md:col-span-2">

            <form action="{{route('docente.update',$docente)}}" method="POST" autocomplete="off">
                @csrf
                @method('PUT')
                    ...
                    <div class="px-2 pb-8 bg-white sm:p-6 rounded-t-md ">
                        <div class="grid grid-cols-12 gap-2 sm:gap-10">
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                value="{{ old('nombre') ?? ($docente ? $docente->nombre : '')}}"
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                value="{{old('apellido') ?? ($docente ? $docente->apellido : '')}}"
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                <input type="text" name="cuil" id="cuil" maxlength="30" required
                                value="{{old('cuil') ?? ($docente ? $docente->cuil : '')}}"
                                placeholder="CUIL del profesor"
                                class="relative outline-none rounded py-1 px-2 w-full h-full bg-white shadow text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:shadow-outline">
                                @error('cuil')
                                <span class=" text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                value="{{old('titulo') ?? ($docente ? $docente->titulo : '')}}"
                                class="relative outline-none rounded py-1 px-2 w-full h-full bg-white shadow text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:shadow-outline">
                                @error('titulo')
                                <span class=" text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                value="{{old('categoriaTitulo') ?? ($docente ? $docente->categoriaTitulo : '')}}"
                                class="relative outline-none rounded py-1 px-2 w-full h-full bg-white shadow text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:shadow-outline">
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                value="{{old('localidad') ?? ($docente ? $docente->localidad : '')}}"
                                class="relative outline-none rounded py-1 px-2 w-full h-full bg-white shadow text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:shadow-outline">
